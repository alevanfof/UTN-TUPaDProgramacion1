...
while vida_jugador > 0 and vida_enemigo > 0:
    ...
    if opcion == 1:
        ...
        print(f"¡Atacaste al enemigo por {int(daño_final)} puntos de daño!")
        ...
        if pociones > 0:
            vida_jugador += 30
            pociones -= 1
            print(f"¡Curaste 30 HP! Vida actual: {vida_jugador}")
        else:
    ...
    if vida_enemigo > 0:
        ...
        print(f">> ¡El enemigo te atacó por {daño_enemigo} puntos!")
